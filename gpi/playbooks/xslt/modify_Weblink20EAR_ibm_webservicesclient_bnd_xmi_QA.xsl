...
<xsl:param name="VehicleHttpPort">http://ws.cqqa.com:6510/2006/services/VehicleHttpPort</xsl:param>
<xsl:param name="InventoryServicePort">http://ws.qa.gpi.com:80/was/InventoryServiceWeb/InventoryServiceService</xsl:param>
<xsl:param name="GpiPaoServiceSOAP">http://qa-exapps02.gpi.com/link/WebService/BrandedGpi/GpiPaoService.php</xsl:param>
<xsl:param name="TransactionLogServicePort">http://ws.qa.gpi.com:80/TransactionLogServiceWeb/TransactionLogServiceService</xsl:param>
<xsl:param name="InventoryPort">http://cwsappqa01.corp.advancestores.com:9480/CWSAdapter/Inventory</xsl:param>
<xsl:param name="AccountStatusPort">http://cwsappqa01.corp.advancestores.com:9480/CWSAdapter/AccountStatus</xsl:param>
<xsl:param name="OrderFulfillmentPort">http://cwsappqa01.corp.advancestores.com:9480/CWSAdapter/OrderFulfillment</xsl:param>
<xsl:param name="OrderQuotePort">http://cwsappqa01.corp.advancestores.com:9480/CWSAdapter/OrderQuote</xsl:param>
